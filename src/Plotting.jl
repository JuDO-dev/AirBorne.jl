...
function plot_error_vs_depth(array::Array, start::Int, max_depth::Int, error_type::String, gamma::Float64)
    Plots.plot(start:max_depth, array, seriestype = :scatter)
...
function plot_error_vs_gamma(array::Array, gamma_vals, error_type::String)
    Plots.plot(gamma_vals, array, seriestype = :scatter)
...
function plot_histogram(array::Array, normal_dist, x_vals, pdf, kde, error_type::String, num_bins::Int)
